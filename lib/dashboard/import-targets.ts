  ...
  switch (target) {
    ...
    case "utilities":
      return [
        ...
        "Providers (exact labels): K-Electric — SURWAY NO 239G Mill | K-Electric — SURWAY NO 234G Mill | K-Electric — Clifton Office | K-Electric — Personal House | PTCL | SSGC (Gas) — Clifton Office | SSGC (Gas) — Personal House | KWSB (Water Board) — Clifton Office | Jazz monthly bill — Khalid Paracha | Jazz monthly bill — Sadia Paracha.",
