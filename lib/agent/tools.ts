...
const agentReadTools: FunctionDeclaration[] = [
  ...
  },
  {
    ...
    description:
      "List utility accounts with ids and exact provider labels used by the Utilities dashboard (K-Electric sites, SSGC sites, KWSB Clifton, Jazz Khalid/Sadia, PTCL). Call this BEFORE utility_payment_create so you can map a bill PDF to the correct utility_account_id. Never returns passwords.",
    parameters: {
      type: SchemaType.OBJECT,
      properties: {
        utility_type: {
